...
public class BuilderManager {
    ...
    static TextInsideCircleButton.Builder getTextInsideCircleButtonBuilder(int str) {
        return new TextInsideCircleButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(str);
    }

    static TextInsideCircleButton.Builder getSquareTextInsideCircleButtonBuilder(int str) {
        return new TextInsideCircleButton.Builder()
                .isRound(false)
    ...
    static TextInsideCircleButton.Builder getTextInsideCircleButtonBuilderWithDifferentPieceColor(int str) {
        return new TextInsideCircleButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(str)
    ...
    static TextOutsideCircleButton.Builder getTextOutsideCircleButtonBuilder(int str) {
        return new TextOutsideCircleButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(str);
    }

    static TextOutsideCircleButton.Builder getSquareTextOutsideCircleButtonBuilder(int str) {
        return new TextOutsideCircleButton.Builder()
                .isRound(false)
    ...
    static TextOutsideCircleButton.Builder getTextOutsideCircleButtonBuilderWithDifferentPieceColor(int str) {
        return new TextOutsideCircleButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(str)
                .pieceColor(Color.WHITE);
    ...
    static HamButton.Builder getHamButtonBuilder(int str, int sub_str) {
        return new HamButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(str)
                .subNormalTextRes(sub_str);
    }
    ...
    static HamButton.Builder getPieceCornerRadiusHamButtonBuilder(int str, int sub_str) {
        return new HamButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(str)
                .subNormalTextRes(sub_str);
    ...
    public static HamButton.Builder getHamButtonBuilderWithDifferentPieceColor(int getImage, int str, int sub_str) {
        return new HamButton.Builder()
